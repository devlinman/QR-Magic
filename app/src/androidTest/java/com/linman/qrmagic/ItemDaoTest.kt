...
import com.linman.qrmagic.data.InventoryDatabase
import com.linman.qrmagic.data.Item
import com.linman.qrmagic.data.ItemDao
...
class ItemDaoTest {
    ...
    @Test
    @Throws(Exception::class)
    fun daoGetItemByName_returnsItemFromDB() = runBlocking {
        addOneItemToDb()
        val item = itemDao.getItemByName("Apples")
